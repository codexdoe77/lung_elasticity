...
# ---- SAVE TO USD ----
# u_field.name = "u"
# output_usd = "youngs_modulus_and_deformation.usd"
# fem.save_usd(
#     output_usd,
#     fields={"E": E_field, "u": u_field},
#     geometry=geo,
#     show_grid=False
# )

# print(f"Saved USD visualization to: {output_usd}")
