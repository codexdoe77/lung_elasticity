...
class ParticleSystem
{
    public:
        ...
        float update(float deltaTime, bool magnify, int iteration_counter);
        ...
        float4 updateElasticity(int, float, float *array, bool, DATA_VOLUME *inputDataset, float &mmPercent);
        float4 updateElasticityOld(int, float, float *array, bool, DATA_VOLUME *inputDataset);
        ...
        void resetElasticityNeighbors(DATA_VOLUME *inputData);
        void resetElasticityforMagnify(float modulus);
        void resetElasticityforOptimization(bool total);
        ...
        void setElasticityAndAssociatedParameters(int i, float value, float minMod, float maxMod);
        ...
        void dumpResults(DATA_VOLUME *grid);
        void dumpParticles( DATA_VOLUME *grid, float *array, const char* fileName);
        void dumpParticles_absDiff( DATA_VOLUME *grid, float *array1, float* array2, const char* fileName);
